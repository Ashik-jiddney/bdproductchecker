...
if (!mysqli_stmt_prepare($stmt, $sql)) {
  ...
  mysqli_stmt_bind_param($stmt, "isssssssssssi",$idno, $name, $email, $birthdate, $interview_time, $interview_platform, $interview_link, $interview_id, $interview_pass, $interview_status, $result_status, $result_team,$idno);
